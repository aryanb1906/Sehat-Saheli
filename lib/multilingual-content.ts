export interface LanguageContent {
  ...
  // Main Actions
  talkToSaheli: string
  talkToSaheliSubtitle: string
  myHealthLog: string
  myHealthLogSubtitle: string
  mentalHealth: string
  mentalHealthSubtitle: string
  emergencyCall: string
  emergencyCallSubtitle: string
  ...
  ashaDescription: string

  // ASHA-specific
  ashaDashboard: string
  welcomeBack: string
  ...
  checkupsMonth: string
  followUpRate: string
  thisWeek: string
  riskDistribution: string
  weeklyCheckups: string
...
export function getContent(languageCode: string): LanguageContent {
